# DENZEL
Toutes les requêtes fonctionnent. Cependant, il y a 2 choses que j'ai fait différemment.
D'abord, le post de la partie Rest ne fonctionne pas dans la console mais fonctionne sur Insomnia.
Ensuite, la requête search de la partie Rest s'écrit sans le /movies, il ne reconnaissait pas la requête sinon.
